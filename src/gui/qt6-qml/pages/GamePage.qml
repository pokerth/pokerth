    ...
    ColumnLayout {
        ...
        Item {
            ...
            readonly property int landscapeRowCount: seatCount <= 4 ? 1
                ...
                : seatCount <= 8 ? 3
                : 4
            // Eingaben der Layout-Rechnung (seatlayout.js). Bewusst ein einziges
            // Objekt: so ist an einer Stelle sichtbar, wovon Boxgröße und Sitz-
            // positionen abhängen - und die Mathematik bleibt frei von QML-Objekten.
            ...
            // Größte Skala, bei der alle Boxen überlappungsfrei liegen (Bisektion).
            ...
            // Slot-Reihenfolge der aktuellen Verteilung (Tabellen in seatlayout.js).
            ...
            readonly property real selfVisualTopY: {
                ...
                // Oberkante der visuell skalierten Self-Box - algebraisch aus ihren
                // eigenen Bindings aufgelöst statt aus selfBox.y gelesen:
                ...
                // Das hält die Layout-Rechnung frei von einer Rückkopplung auf ein
                // UI-Element, das selbst aus boxScale abgeleitet ist (m = bottomMargin
                // ohne den Skalen-Ausgleich, s. selfBox.anchors.bottomMargin).
