...
#ifndef _ASYNCDBLIVESTATS_H_
#define _ASYNCDBLIVESTATS_H_

#include <dbofficial/singleasyncdbquery.h>


class AsyncDBLiveStats : public SingleAsyncDBQuery
{
public:
	AsyncDBLiveStats(const std::string &preparedName, const std::list<std::string> &params);
	virtual ~AsyncDBLiveStats();
