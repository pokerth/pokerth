...
static asn_TYPE_tag2member_t asn_MAP_raiseIntervalMode_tag2el_4[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* raiseEveryHands at 302 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* raiseEveryMinutes at 303 */
};
...
static asn_TYPE_tag2member_t asn_MAP_NetGameInfo_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 1, 0, 6 }, /* maxNumPlayers at 300 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 4, -1, 5 }, /* proposedGuiSpeed at 310 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 5, -2, 4 }, /* delayBetweenHands at 311 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 6, -3, 3 }, /* playerActionTimeout at 312 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 7, -4, 2 }, /* firstSmallBlind at 313 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 8, -5, 1 }, /* endRaiseSmallBlindValue at 314 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 9, -6, 0 }, /* startMoney at 315 */
    { (ASN_TAG_CLASS_UNIVERSAL | (10 << 2)), 3, 0, 0 }, /* endRaiseMode at 306 */
    { (ASN_TAG_CLASS_UNIVERSAL | (12 << 2)), 0, 0, 0 }, /* gameName at 299 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 10, 0, 0 }, /* manualBlinds at 316 */
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 2, 0, 0 }, /* raiseEveryHands at 302 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 2, 0, 0 } /* raiseEveryMinutes at 303 */
};
