...
static asn_TYPE_tag2member_t asn_MAP_avatarData_tag2el_6[] = {
	{ (ASN_TAG_CLASS_UNIVERSAL | (4 << 2)), 1, 0, 0 }, /* avatar at 265 */
	{ (ASN_TAG_CLASS_UNIVERSAL | (10 << 2)), 0, 0, 0 } /* avatarType at 263 */
};
...
static asn_TYPE_tag2member_t asn_MAP_PlayerInfoData_tag2el_1[] = {
	{ (ASN_TAG_CLASS_UNIVERSAL | (1 << 2)), 1, 0, 0 }, /* isHuman at 259 */
	{ (ASN_TAG_CLASS_UNIVERSAL | (10 << 2)), 2, 0, 0 }, /* playerRights at 260 */
	{ (ASN_TAG_CLASS_UNIVERSAL | (12 << 2)), 0, 0, 1 }, /* playerName at 258 */
	{ (ASN_TAG_CLASS_UNIVERSAL | (12 << 2)), 3, -1, 0 }, /* countryCode at 261 */
	{ (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 4, 0, 0 } /* avatarData at 263 */
};
