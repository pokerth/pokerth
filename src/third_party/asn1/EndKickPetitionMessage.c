...
static asn_TYPE_tag2member_t asn_MAP_EndKickPetitionMessage_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (1 << 2)), 3, 0, 0 }, /* resultPlayerKicked at 493 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 0, 0, 2 }, /* petitionId at 490 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 1, -1, 1 }, /* numVotesAgainstKicking at 491 */
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 2, -2, 0 }, /* numVotesInFavourOfKicking at 492 */
    { (ASN_TAG_CLASS_UNIVERSAL | (10 << 2)), 4, 0, 0 } /* petitionEndReason at 495 */
};
