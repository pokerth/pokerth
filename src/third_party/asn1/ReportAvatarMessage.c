...
static asn_TYPE_tag2member_t asn_MAP_ReportAvatarMessage_tag2el_1[] = {
	{ (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 0, 0, 0 }, /* reportedPlayerId at 764 */
	{ (ASN_TAG_CLASS_UNIVERSAL | (4 << 2)), 1, 0, 0 } /* reportedAvatar at 766 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ReportAvatarMessage_specs_1 = {
	sizeof(struct ReportAvatarMessage),
	offsetof(struct ReportAvatarMessage, _asn_ctx),
	asn_MAP_ReportAvatarMessage_tag2el_1,
	2,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	1,	/* Start extensions */
	3	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_ReportAvatarMessage = {
	"ReportAvatarMessage",
	"ReportAvatarMessage",
	SEQUENCE_free,
	SEQUENCE_print,
	...
	2,	/* Elements count */
	&asn_SPC_ReportAvatarMessage_specs_1	/* Additional specs */
};
