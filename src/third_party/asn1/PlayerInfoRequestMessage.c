...
static asn_TYPE_tag2member_t asn_MAP_PlayerInfoRequestMessage_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 0, 0, 0 } /* playerId at 196 */
};
static asn_SEQUENCE_specifics_t asn_SPC_PlayerInfoRequestMessage_specs_1 = {
	sizeof(struct PlayerInfoRequestMessage),
	offsetof(struct PlayerInfoRequestMessage, _asn_ctx),
	asn_MAP_PlayerInfoRequestMessage_tag2el_1,
	1,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	0,	/* Start extensions */
	2	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_PlayerInfoRequestMessage = {
	...
	1,	/* Elements count */
	&asn_SPC_PlayerInfoRequestMessage_specs_1	/* Additional specs */
};
