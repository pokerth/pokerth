...
#define POKERTH_VERSION_MAJOR	2
...
#define POKERTH_BETA_RELEASE_STRING	 "2.1.1"

// --- Client type identifiers (encoded in high byte of buildId) ---
#define CLIENT_TYPE_QT_WIDGET	0x01	// Qt Widget client (final release: 2.1.1)
...
// Qt Widget: min 2.1.0, current 2.1.1 (both allowed)
#define MIN_BUILD_ID_QT_WIDGET	MAKE_BUILD_ID(CLIENT_TYPE_QT_WIDGET, 2, 1, 0)
// QML: min 2.1.0, current 2.1.1 (both allowed); update min to previous release with each new release
#define MIN_BUILD_ID_QML		MAKE_BUILD_ID(CLIENT_TYPE_QML, 2, 1, 0)
