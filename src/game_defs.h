...
// Qt Widget: min 2.0.6 (if a bugfix 2.0.7 is released, bump version above and keep min at 2.0.6)
#define MIN_BUILD_ID_QT_WIDGET	MAKE_BUILD_ID(CLIENT_TYPE_QT_WIDGET, 2, 0, 6)
