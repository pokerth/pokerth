...
#define SERVER_GAME_ADMIN_TIMEOUT_SEC				1800	// 30 min, MUST be > SERVER_GAME_ADMIN_WARNING_REMAINING_SEC
#define SERVER_GAME_AFK_WARNING_SEC					1200	// 20 min - warn player after this idle time
#define SERVER_GAME_AFK_KICK_SEC					1260	// 21 min - kick player (60s after warning)
