...
#define NTF_NET_CREATE_GUEST_FORBIDDEN	210
#define NTF_NET_CREATE_GAME_NAME_IN_USE	211
#define NTF_NET_CREATE_GAME_BAD_NAME	212
#define NTF_NET_CREATE_INVALID_SETTINGS	213

// Notifications - join failed
#define NTF_NET_JOIN_GAME_INVALID		220
#define NTF_NET_JOIN_GAME_FULL			221
#define NTF_NET_JOIN_ALREADY_RUNNING	222
#define NTF_NET_JOIN_GUEST_FORBIDDEN	223
#define NTF_NET_JOIN_INVALID_PASSWORD	224
#define NTF_NET_JOIN_NOT_INVITED		225
#define NTF_NET_JOIN_IP_BLOCKED			226
#define NTF_NET_JOIN_REJOIN_FAILED		227
#define NTF_NET_JOIN_NO_SPECTATORS		228
